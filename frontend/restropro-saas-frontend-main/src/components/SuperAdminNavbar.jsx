...
import Logo from "../assets/logo-dotresto.png";
import LogoDark from "../assets/logo-dotresto-dark.png";
...
export default function SuperAdminNavbar() {
  ...
  if (isNavbarCollapsed) {
    return (
      <div className ="hidden md:flex flex-col items-start gap-4 h-screen px-5 py-6 overflow-y-auto fixed left-0 top-0 bg-restro-green-light">
  ...
  return (
    <div className="relative h-screen">
      <div className='hidden md:flex md:w-72 flex-col items-start gap-2 md:gap-3 h-screen px-5 py-6 overflow-y-auto fixed left-0 top-0 border-r border-restro-border-green bg-restro-card-bg'>
