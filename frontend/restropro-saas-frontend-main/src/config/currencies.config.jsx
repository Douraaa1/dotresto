...
export const STRIPE_SUPPORTCURRENCIES = [
  { cc: "AED", symbol: "د.إ", name: "UAE dirham", country: "United Arab Emirates" },
  { cc: "AUD", symbol: "$", name: "Australian dollar", country: "Australia" },
  { cc: "BDT", symbol: "৳", name: "Bangladeshi taka", country: "Bangladesh" },
  { cc: "BHD", symbol: ".د.ب", name: "Bahraini dinar", country: "Bahrain" },
  { cc: "BRL", symbol: "R$", name: "Brazilian real", country: "Brazil" },
  { cc: "CAD", symbol: "$", name: "Canadian dollar", country: "Canada" },
  { cc: "CHF", symbol: "Fr.", name: "Swiss franc", country: "Switzerland" },
  { cc: "CLP", symbol: "$", name: "Chilean peso", country: "Chile" },
  { cc: "CNY", symbol: "¥", name: "Chinese yuan", country: "China" },
  { cc: "CZK", symbol: "Kč", name: "Czech koruna", country: "Czech Republic" },
  { cc: "DKK", symbol: "Kr", name: "Danish krone", country: "Denmark" },
  { cc: "EGP", symbol: "£", name: "Egyptian pound", country: "Egypt" },
  { cc: "EUR", symbol: "€", name: "Euro", country: "Eurozone" },
  { cc: "GBP", symbol: "£", name: "British pound", country: "United Kingdom" },
  { cc: "HKD", symbol: "HK$", name: "Hong Kong dollar", country: "Hong Kong" },
  { cc: "HUF", symbol: "Ft", name: "Hungarian forint", country: "Hungary" },
  { cc: "IDR", symbol: "Rp", name: "Indonesian rupiah", country: "Indonesia" },
  { cc: "ILS", symbol: "₪", name: "Israeli new shekel", country: "Israel" },
  { cc: "INR", symbol: "₹", name: "Indian rupee", country: "India" },
  { cc: "JPY", symbol: "¥", name: "Japanese yen", country: "Japan" },
  { cc: "KRW", symbol: "₩", name: "South Korean won", country: "South Korea" },
  { cc: "KWD", symbol: "KWD", name: "Kuwaiti dinar", country: "Kuwait" },
  { cc: "MXN", symbol: "$", name: "Mexican peso", country: "Mexico" },
  { cc: "MYR", symbol: "RM", name: "Malaysian ringgit", country: "Malaysia" },
  { cc: "NOK", symbol: "kr", name: "Norwegian krone", country: "Norway" },
  { cc: "NZD", symbol: "$", name: "New Zealand dollar", country: "New Zealand" },
  { cc: "PHP", symbol: "₱", name: "Philippine peso", country: "Philippines" },
  { cc: "PLN", symbol: "zł", name: "Polish złoty", country: "Poland" },
  { cc: "SAR", symbol: "﷼", name: "Saudi riyal", country: "Saudi Arabia" },
  { cc: "SEK", symbol: "kr", name: "Swedish krona", country: "Sweden" },
  { cc: "SGD", symbol: "$", name: "Singapore dollar", country: "Singapore" },
  { cc: "THB", symbol: "฿", name: "Thai baht", country: "Thailand" },
  { cc: "TRY", symbol: "₺", name: "Turkish lira", country: "Turkey" },
  { cc: "USD", symbol: "$", name: "US dollar", country: "United States" },
  { cc: "ZAR", symbol: "R", name: "South African rand", country: "South Africa" }
];

export const PAYSTACK_SUPPORTCURRENCIES = [
  { cc: "NGN", symbol: "₦", name: "Nigerian naira", country: "Nigeria" },
  { cc: "USD", symbol: "$", name: "US dollar", country: "Kenya, Nigeria" },
  { cc: "GHS", symbol: "₵", name: "Ghanaian cedi", country: "Ghana" },
  { cc: "ZAR", symbol: "R", name: "South African rand", country: "South Africa" },
  { cc: "KES", symbol: "Ksh", name: "Kenyan shilling", country: "Kenya" },
  { cc: "XOF", symbol: "XOF", name: "West African CFA franc", country: "Côte d'Ivoire" },
];